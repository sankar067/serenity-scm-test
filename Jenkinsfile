...
// 	    echo "Failed Tags - ${ftags}"
            bat "C:\\Sankar\\JenkinsSetUp\\apache-maven-3.5.3\\bin\\mvn.cmd  verify \"-Dmetafilter=${env.failedtags}\" -Dwebdriver.driver=chrome -f pom.xml -Dmaven.surefire.debug=true"
